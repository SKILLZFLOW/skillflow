...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.VideoInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).video.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.VideoInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).video.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.VideoInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).video.findFirst(input as any))),

        findMany: procedure.input($Schema.VideoInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).video.findMany(input as any))),
        ...
        count: procedure.input($Schema.VideoInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).video.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.VideoCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.VideoCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.VideoCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.VideoCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.VideoCountArgs>, 'cursor'>,
